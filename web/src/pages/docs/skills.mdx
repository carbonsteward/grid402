...
The repository copy at [`skills.md`](https://github.com/grid402/grid402/blob/main/skills.md) includes per-skill install patterns, complete call examples, redistribution notes for each provider, and contributing guidelines.
